...
export default function Register() {
  ...
  const handlePaste = (e: React.ClipboardEvent<HTMLInputElement>) => {
    e.preventDefault();
    setError('No se permite pegar en el campo de contrasena. Por favor, escribela manualmente.');
        ...
        <div className="max-w-lg w-full space-y-8">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold" style={{ color: COLORS.text }}>
              {isApprentice ? '¡Conviertete en Aprendiz!' : 'Completa tu Suscripcion'}
            </h2>
          </div>
          ...
          {isApprentice ? (
            ...
            >
              ...
              PAGAR SUSCRIPCION MENSUAL DE $190 MXN
            </a>
          ) : (
            <a
              href={selectedPlan.mercadoPagoLink}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs mt-1" style={{ color: COLORS.textMuted }}>
                No puedes pegar en este campo. Escribe tu contrasena manualmente.
              </p>
            </div>
